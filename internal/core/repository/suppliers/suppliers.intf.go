...
type ISuppliersRepository interface {
	...
	GetLimit(ctx context.Context, limit int) ([]entity.Suppliers, error)
	...
	GetByPhone(ctx context.Context, phone string) (*entity.Suppliers, error)
	...
	Edit(ctx context.Context, sup entity.Suppliers) error
}
