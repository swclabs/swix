...
type IPurchaseService interface {
	...
	AddToCart(ctx context.Context, cart dto.CartInsert) error
	...
	GetCart(ctx context.Context, userID int64, limit int) (*dto.CartSlices, error)
	...
	CreateOrders(ctx context.Context, createOrder dto.CreateOrderSchema) (string, error)
	...
	GetOrdersByUserID(ctx context.Context, userID int64, limit int) ([]dto.OrderSchema, error)
}
